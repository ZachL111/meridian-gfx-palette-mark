...
`meridian-gfx-palette-mark` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for palette systems, covering resource planning, capacity fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 157. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 2.
